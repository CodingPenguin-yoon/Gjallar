...
> Historical note: this smoke record is preserved for audit history and may mention legacy endpoints or flows that are not part of the current `/api/v1` repo-local contract. For current docs, start at [`../../README.md`](../../README.md).
