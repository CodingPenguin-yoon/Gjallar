...
import { isProxmoxOperational, normalizeProxmoxConnection } from '../utils/proxmoxConnection'
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 text-sm text-slate-600">
            실제 Proxmox inventory를 확인할 수 있을 때만 VM, Create, Network, DRS 화면을 엽니다. Jobs, Risks, Account, Admin은 계속 사용할 수 있습니다.
          </p>
