...
assert.match(appSource, /path="\/account"/, 'App must expose an authenticated account route')
...
assert.match(appSource, /Account/, 'Account nav item must be available for authenticated users')
