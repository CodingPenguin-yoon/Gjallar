...
assert.match(appSource, /<DrsPoliciesPage currentUser=\{currentUser\} canManageDrsPolicies=\{canMutate\}/, 'DRS Policies page must receive role permission')
assert.match(appSource, /<DrsAdvisorPage currentUser=\{currentUser\} canOperate=\{canMutate\}/, 'DRS Advisor page must receive session user and operator permission')
