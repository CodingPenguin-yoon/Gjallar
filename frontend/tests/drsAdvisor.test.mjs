...
const policyModalSource = readFileSync(new URL('../src/components/DrsPolicyReviewModal.jsx', import.meta.url), 'utf8')
...
assert.match(policyModalSource, /Policy changes do not start migration/)
assert.match(policyModalSource, /Allowed is only a prerequisite/)
...
assert.doesNotMatch(policyModalSource, /actor:|updated_by:|operator_id|source:/)
