...
assert.match(screenSource, /Manage VM policies/)
assert.match(screenSource, /to="\/instances\/drs-policies"/)
assert.match(screenSource, /Policy source/)
assert.match(screenSource, /Policy reason/)
assert.doesNotMatch(screenSource, /VM Policy Configuration/)
assert.doesNotMatch(screenSource, /PolicyCoveragePanel/)
assert.doesNotMatch(screenSource, /PolicyReviewModal/)
assert.doesNotMatch(screenSource, /loadDrsPolicyCoverage/)
assert.doesNotMatch(screenSource, /submitDrsPolicyUpdate/)
assert.doesNotMatch(screenSource, /policyWriteBlockers/)
assert.doesNotMatch(screenSource, /policy_change_acknowledged|policyChangeAcknowledged/)
assert.doesNotMatch(screenSource, /migration approval remains separate/)
