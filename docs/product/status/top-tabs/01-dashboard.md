...
[DRS Advisor UI 목표](../../prd/drs-advisor/02_UI_AND_FLOWS.md) 대비 top 1-3 DRS recommendation summary가 없다. CPU/Memory도 current만 있고 최근 15분 average/peak evidence가 없다.
