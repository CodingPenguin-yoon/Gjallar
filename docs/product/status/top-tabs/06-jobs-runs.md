...
[DRS UI/flow 목표](../../prd/drs-advisor/02_UI_AND_FLOWS.md) 대비 `drs_migration` job_type, recommendation_id, VM locator, identity assertion id, source/target node, approver, UPID, lock id/status, timeout_at, post-check result가 없다.
