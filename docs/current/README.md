...
- Goal 11 criteria/taxonomy and Jobs/Runs evidence focused backend validation
  `PYTHONPATH=backend backend/venv/bin/python -m pytest -q backend/tests/drs/test_advisor_readiness.py backend/tests/contracts/test_api_v1_drs.py backend/tests/drs/test_execution.py backend/tests/proxmox/test_mutation_client.py`:
  `96 passed, 37 subtests passed`.
- Goal 11 recommendation/check frontend validation
  `node --test frontend/tests/drsAdvisor.test.mjs frontend/tests/apiV1Client.test.mjs frontend/tests/apiV1ViewModels.test.mjs`:
  `3 passed`; `pnpm --dir frontend build` and `git diff --check` passed.
- Goal 11 Jobs/Runs DRS evidence focused validation
  `PYTHONPATH=backend backend/venv/bin/python -m pytest -q backend/tests/drs/test_execution.py backend/tests/jobs/test_runs.py backend/tests/contracts/test_api_v1_drs.py`:
  `59 passed, 33 subtests passed`; `node --test frontend/tests/jobsScreen.test.mjs frontend/tests/apiV1Client.test.mjs frontend/tests/apiV1ViewModels.test.mjs`:
  `3 passed`; `pnpm --dir frontend lint`, `pnpm --dir frontend build`, and `git diff --check` passed.
