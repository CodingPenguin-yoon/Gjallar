...
This folder preserves the older numbered PRD set inside the repo in numeric order. These files are design history and working context, not the active product source of truth.

## How to use this folder

- Use [`../../current/README.md`](../../current/README.md) for the current implemented-state summary.
- Use this `legacy-prd/` folder for older product definition, rewrite planning, handoff material, and historical working decisions.
- Treat PRD files as design and planning context, not as a guarantee that every described endpoint or flow is live today.

## Product identity

Current MVP product source of truth is [`../../product/drs-advisor/`](../../product/drs-advisor/README.md). If this document conflicts with that folder, `docs/product/drs-advisor/` wins.

Gjallar is a human-facing Proxmox Enterprise Operations Platform.
The current MVP direction is [`../../product/drs-advisor/`](../../product/drs-advisor/README.md): observe Proxmox-native inventory/migration/HA state, recommend safe live migrations, require approval, execute through Proxmox, and track jobs/reconciliation.
...
| `../../product/drs-advisor/README.md` | Current DRS Advisor source of truth |

## Current vs historical

- Current MVP direction points to [`../../product/drs-advisor/`](../../product/drs-advisor/README.md); `24_DRS_ADVISOR_MVP_PRD.md` is only a numeric index.
- Current repo-local state and verification belong under [`../../current/`](../../current/README.md) and [`../../operations/`](../../operations/runbook.md).
...
- Current Create VM profile/template/network target design is [`../../architecture/CREATE_VM_PROFILE_TEMPLATE_NETWORK_DESIGN.md`](../../architecture/CREATE_VM_PROFILE_TEMPLATE_NETWORK_DESIGN.md); status docs identify what is not implemented yet.
- Current engineering docs live under [`../../architecture/`](../../architecture/); historical feature, operations, and roadmap notes live under [`../../archive/`](../../archive/).
