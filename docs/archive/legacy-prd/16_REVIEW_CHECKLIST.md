...
> This create-first checklist is historical/supporting capability context only. DRS Advisor review should follow `docs/product/drs-advisor/` scope, final pre-check, migration execution, and reconciliation rules.
