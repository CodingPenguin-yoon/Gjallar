...
현재 MVP 방향은 `docs/product/drs-advisor/README.md`가 우선한다.
...
[`docs/architecture/CREATE_VM_PROFILE_TEMPLATE_NETWORK_DESIGN.md`](../../architecture/CREATE_VM_PROFILE_TEMPLATE_NETWORK_DESIGN.md)다.
...
현재 MVP 기준 문서는 `docs/product/drs-advisor/README.md`다.
