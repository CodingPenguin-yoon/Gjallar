...
> Historical planning note: this execution plan preserves rewrite-era working assumptions and may mention legacy endpoint names or parked flows. Treat [`../../current/README.md`](../../current/README.md) and [`../../operations/runbook.md`](../../operations/runbook.md) as the current repo-local state.
...
> 현재 활성 제품 source of truth: `docs/product/drs-advisor/`
...
과거 create-first 구현 단위는 PRD의 `21_MVP_IMPLEMENTATION_HANDOFF.md` 기준으로 다음 흐름이었다.
현재 다음 구현 순서는 `docs/product/drs-advisor/05_IMPLEMENTATION_PLAN.md`가 정한다.
...
- Codex VM의 shared documentation/IaC 접근 방식 필요.
