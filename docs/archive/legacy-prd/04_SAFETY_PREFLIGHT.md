...
> This create-first safety material is historical/supporting capability context. DRS Advisor execution must use `docs/product/drs-advisor/04_DRS_RECOMMENDATION_AND_EXECUTION.md` final pre-check rules when there is any conflict.
