...
> This document records an older create-first PRD cleanup. Current MVP product source of truth is `docs/product/drs-advisor/`; if this document conflicts with that folder, `docs/product/drs-advisor/` wins.
