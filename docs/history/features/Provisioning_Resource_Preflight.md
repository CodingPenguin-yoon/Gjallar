...
- `docs/history/operations/Create_VM_End_to_End_Smoke_2026-05-03.md` — actual Create VM smoke on `yoonmanserver2`, including failed shrink path and successful `disk_size_gb=200` path.
