...
> Existing-VM lifecycle action material here is historical context. DRS Advisor execution must follow `../../product/prd/drs-advisor/` final pre-check, approval, Proxmox task tracking, and reconciliation rules.
